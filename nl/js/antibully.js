...
jQuery(document).ready(function($) {
	...
	bpc.scrollLogic = function() {
		...
		$('.logo').css({left: xx - (545*ipct)/*, top: (50 - (50*ipct))+'%', marginTop: -70 + (80*ipct), width: 495 - (273*ipct), height: 143 - (79*ipct)*/});
		if ($(window).width() < 786) {
			$('.header').css({top: -82 + (82*ipct)});
		}
		$('.scroll').css({bottom: 5 - (81*ipct)});
		//$('.footer .childline').css({right: 40 - (332 * ipct)});
		//if (!bpc.ismobile) $('.footer .childline-sml').css({right: -160 + (191 * ipct)});

		$('.footer .logos').css({right: 40 - (400 * ipct)});
		if (!bpc.ismobile) $('.footer .logos-sml').css({right: -235 + (275 * ipct)});
		...
		if (pg !== 0 && pg !== 8 && bpc.ismobile) {
			...
			TweenMax.to($('.footer .logos-sml'), 0.5, {css: {right: -235}, ease: Quart.easeOut});
		} else if ((pg === 0 || pg === 8) && bpc.ismobile) {
			//TweenMax.to($('.footer .childline-sml'), 0.5, {css: {right: 20}, ease: Quart.easeOut});
			TweenMax.to($('.footer .logos-sml'), 0.5, {css: {right: 20}, ease: Quart.easeOut});
		}
	...
	bpc.page1in = function() {
		try {
			lypn_trackPageView('wat-is-pesten');
		} catch(err) {
			console.log(err);
		}
		$('.wat-is-pesten').css('display', 'table');//.show(0);
		var back = $('.wat-is-pesten').find('.background'),
			h1 = $('.wat-is-pesten').find('h1'),
			p = $('.wat-is-pesten').find('p');
	...
	bpc.page1out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.wat-is-pesten').hide(0); }});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.wat-is-pesten').hide(0); }});
	...
	bpc.page2in = function() {
		try {
			lypn_trackPageView('wat-kan-ik-doen');
		} catch(err) {
			console.log(err);
		}
		$('.wat-kan-ik-doen').css('display', 'table');//show(0);
		var back = $('.wat-kan-ik-doen').find('.background'),
			h1 = $('.wat-kan-ik-doen').find('h1'),
			body = $('.wat-kan-ik-doen').find('.body');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
	...
	bpc.page2out = function() {
		...
		TweenMax.killTweensOf(h1);
		TweenMax.killTweensOf(body);
		$('.wat-kan-ik-doen .copy.open').slideUp(300, 'easeOutQuart').removeClass('open').next('.button').show(0);

		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.wat-kan-ik-doen').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.wat-kan-ik-doen').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
	...
	bpc.page3in = function() {
		try {
			lypn_trackPageView('bekijk-videos');
		} catch(err) {
			console.log(err);
		}
		$('.bekijk-videos').css('display', 'table');//show(0);
		var back = $('.bekijk-videos').find('.background'),
			h1 = $('.bekijk-videos').find('h1'),
			body = $('.bekijk-videos').find('.videos');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
		TweenMax.killTweensOf(body);
	...
	bpc.page3out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.bekijk-videos').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(body, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.bekijk-videos').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			TweenMax.to(body, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.page5in = function() {
		try {
			lypn_trackPageView('ontmoet-clara-en-nieky');
		} catch(err) {
			console.log(err);
		}
		$('.ontmoet-clara-en-nieky').css('display', 'table');//show(0);
		var back = $('.ontmoet-clara-en-nieky').find('.background'),
			h1 = $('.ontmoet-clara-en-nieky').find('h1'),
			//h2 = $('.ontmoet-clara-en-nieky').find('h2'),
			body = $('.ontmoet-clara-en-nieky').find('.text-block');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
	...
	bpc.page5out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.ontmoet-clara-en-nieky').hide(0); }});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.ontmoet-clara-en-nieky').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
	...
	bpc.page4in = function() {
		try {
			lypn_trackPageView('ambassadeurs');
		} catch(err) {
			console.log(err);
		}
		$('.ambassadeurs').css('display', 'table');//show(0);
		var back = $('.ambassadeurs').find('.background'),
			h1 = $('.ambassadeurs').find('h1'),
			//h2 = $('.ambassadeurs').find('h2'),
			body = $('.ambassadeurs').find('.wide-responsive');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
		//TweenMax.killTweensOf(h2);
		TweenMax.killTweensOf(body);
	...
	bpc.page4out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.ambassadeurs').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.3});
			//TweenMax.to(h2, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(body, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.ambassadeurs').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			//TweenMax.to(h2, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.1});
			TweenMax.to(body, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.page6in = function() {
		try {
			lypn_trackPageView('maatjes-code');
		} catch(err) {
			console.log(err);
		}
		$('.maatjes-code').css('display', 'table');//show(0);
		var back = $('.maatjes-code').find('.background'),
			h1 = $('.maatjes-code').find('h1'),
			body = $('.maatjes-code').find('.body');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
		TweenMax.killTweensOf(body);
	...
	bpc.page6out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.maatjes-code').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(body, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.maatjes-code').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			TweenMax.to(body, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.page7in = function() {
		try {
			lypn_trackPageView('partners');
		} catch(err) {
			console.log(err);
		}
		$('.partners').css('display', 'table');//show(0);
		var back = $('.partners').find('.background'),
			h1 = $('.partners').find('h1'),
	...
	bpc.page7out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.partners').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(body, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.partners').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			TweenMax.to(body, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.page8in = function() {
		try {
			lypn_trackPageView('vraag-om-hulp');
		} catch(err) {
			console.log(err);
		}
		$('.vraag-om-hulp').css('display', 'table');//show(0);
		var back = $('.vraag-om-hulp').find('.background'),
			h1 = $('.vraag-om-hulp').find('h1'),
			p = $('.vraag-om-hulp').find('p');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
		TweenMax.killTweensOf(p);
	...
	bpc.page8out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.vraag-om-hulp').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(p, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.vraag-om-hulp').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			TweenMax.to(p, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.initNav = function() {
		$('.header .main-nav a, .mobile-nav a').click(function() {
			...
			if ($('.mobile-nav').is(':visible')) {
				...
				TweenMax.to($('.footer .logos-sml'), 0.3, {css: {right: 40}, ease: Quad.easeOut});
			}
		});
		...
		$('.mobile-nav-btn').click(function() {
			...
			TweenMax.to($('.footer .logos-sml'), 0.3, {css: {right: -200}, ease: Quad.easeOut});
			$('.logo').hide(0);
		});
	...
	bpc.initWhatCanIDo = function() {
		$('.wat-kan-ik-doen .button').click(function() {
			$('.wat-kan-ik-doen .copy.open').slideUp(300, 'easeOutQuart').removeClass('open').next('.button').show(0);
	...
	bpc.initWatchVideo = function() {
		$('.videos a').click(function() {
			...
			try {
				lypn_trackPageView('bekijk-videos/'+$(this).attr('data-track'));
			} catch(err) {
				console.log(err);
			}
	...
	bpc.initCelebVids = function() {
		$('.arrows.right').click(function() {
			...
			if ($('.ontmoet-clara-en-nieky').has($(this)).length > 0) {
				$('.ontmoet-clara-en-nieky .background').css('background-image', 'url('+$('.ontmoet-clara-en-nieky .background').attr('data-alt')+')').css('background-position', '80% 0%');
			}
		});
		$('.arrows.left').click(function() {
			...
			if ($('.ontmoet-clara-en-nieky').has($(this)).length > 0) {
				$('.ontmoet-clara-en-nieky .background').css('background-image', 'url('+$('.ontmoet-clara-en-nieky .background').attr('data-preload')+')').css('background-position', '20% 0%');
			}
		});

		$('.ambassadeurs').on('swipeleft', function(){
			if ($('.ambassadeurs .arrows.right').is(':visible'))
				$('.ambassadeurs .arrows.right').click();
		});
		$('.ambassadeurs').on('swiperight', function(){
			if ($('.ambassadeurs .arrows.left').is(':visible'))
				$('.ambassadeurs .arrows.left').click();
		});
		$('.ontmoet-clara-en-nieky').on('swipeleft', function(){
			if ($('.ontmoet-clara-en-nieky .arrows.right').is(':visible'))
				$('.ontmoet-clara-en-nieky .arrows.right').click();
		});
		$('.ontmoet-clara-en-nieky').on('swiperight', function(){
			if ($('.ontmoet-clara-en-nieky .arrows.left').is(':visible'))
				$('.ontmoet-clara-en-nieky .arrows.left').click();
		});
	};
