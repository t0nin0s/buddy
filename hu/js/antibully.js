...
jQuery(document).ready(function($) {
	...
	bpc.scrollLogic = function() {
		...
		$('.footer .unicef').css({right: 40 - (355 * ipct)});
		if (!bpc.ismobile) $('.footer .unicef-sml').css({right: -237 + (257 * ipct)});
		...
		if (pg !== 0 && pg !== 8 && bpc.ismobile) {
			TweenMax.to($('.footer .unicef-sml'), 0.5, {css: {right: -200}, ease: Quart.easeOut});
		} else if ((pg === 0 || pg === 8) && bpc.ismobile) {
			TweenMax.to($('.footer .unicef-sml'), 0.5, {css: {right: 20}, ease: Quart.easeOut});
		}
	...
	bpc.page5in = function() {
		try {
			lypn_trackPageView('az-ebreszto-ora-program');
		} catch(err) {
			console.log(err);
		}
		$('.az-ebreszto-ora-program').css('display', 'table');//show(0);
		var back = $('.az-ebreszto-ora-program').find('.background'),
			h1 = $('.az-ebreszto-ora-program').find('h1'),
			h2 = $('.az-ebreszto-ora-program').find('h2'),
			body = $('.az-ebreszto-ora-program').find('.inline-player');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
	...
	bpc.page5out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.az-ebreszto-ora-program').hide(0); }});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.az-ebreszto-ora-program').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
	...
	bpc.page6in = function() {
		try {
			lypn_trackPageView('buddy-code');
		} catch(err) {
			console.log(err);
		}
		$('.buddy-code').css('display', 'table');//show(0);
		var back = $('.buddy-code').find('.background'),
			h1 = $('.buddy-code').find('h1'),
			body = $('.buddy-code').find('.body');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
		TweenMax.killTweensOf(body);
	...
	bpc.page6out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.buddy-code').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(body, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.buddy-code').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			TweenMax.to(body, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.initNav = function() {
		$('.header .main-nav a, .mobile-nav a').click(function() {
			...
			if ($('.mobile-nav').is(':visible')) {
				...
				$('.mobile-nav').hide(0);
				TweenMax.to($('.footer .unicef-sml'), 0.3, {css: {right: 40}, ease: Quad.easeOut});
			}
		});
		...
		$('.mobile-nav-btn').click(function() {
			...
			TweenMax.to($('.footer .unicef-sml'), 0.3, {css: {right: -200}, ease: Quad.easeOut});
			$('.logo').hide(0);
		});
	...
	bpc.initCelebVids = function() {
		...
		$('.az-ebreszto-ora-program').on('swipeleft', function(){
			if ($('.az-ebreszto-ora-program .arrows.right').is(':visible'))
				$('.az-ebreszto-ora-program .arrows.right').click();
		});
		$('.az-ebreszto-ora-program').on('swiperight', function(){
			if ($('.az-ebreszto-ora-program .arrows.left').is(':visible'))
				$('.az-ebreszto-ora-program .arrows.left').click();
		});
	};
