...
jQuery(document).ready(function($) {
	...
	bpc.page1in = function() {
		try {
			lypn_trackPageView('what-is-bullying');
		} catch(err) {
			console.log(err);
		}
		$('.what-is-bullying').css('display', 'table');//.show(0);
		var back = $('.what-is-bullying').find('.background'),
			h1 = $('.what-is-bullying').find('h1'),
			p = $('.what-is-bullying').find('p');
	...
	bpc.page1out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.what-is-bullying').hide(0); }});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.what-is-bullying').hide(0); }});
	...
	bpc.page2in = function() {
		try {
			lypn_trackPageView('what-can-i-do');
		} catch(err) {
			console.log(err);
		}
		$('.what-can-i-do').css('display', 'table');//show(0);
		var back = $('.what-can-i-do').find('.background'),
			h1 = $('.what-can-i-do').find('h1'),
			body = $('.what-can-i-do').find('.body'),
			arrows = $('.what-can-i-do').find('.arrows');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
		...
		TweenMax.to(arrows, 0.5, {alpha: 1, ease: Quart.easeOut, delay: bpc.showDelay + 0.2});
	};
	...
	bpc.page2out = function() {
		...
		TweenMax.killTweensOf(body);
		TweenMax.killTweensOf(arrows);
		$('.what-can-i-do .copy.open').slideUp(300, 'easeOutQuart').removeClass('open').next('.button').show(0);

		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.what-can-i-do').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.what-can-i-do').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
		...
		TweenMax.to(arrows, 0.5, {alpha: 0, ease: Quart.easeOut, delay: 0});
	};

	bpc.page3in = function() {
		try {
			lypn_trackPageView('watch-videos');
		} catch(err) {
			console.log(err);
		}
		$('.watch-videos').css('display', 'table');//show(0);
		var back = $('.watch-videos').find('.background'),
			h1 = $('.watch-videos').find('h1'),
			body = $('.watch-videos').find('.videos');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
		TweenMax.killTweensOf(body);
	...
	bpc.page3out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.watch-videos').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(body, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.watch-videos').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			TweenMax.to(body, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.page5in = function() {
		try {
			lypn_trackPageView('advice-from-childline');
		} catch(err) {
			console.log(err);
		}
		$('.advice-from-childline').css('display', 'table');//show(0);
		var back = $('.advice-from-childline').find('.background'),
			h1 = $('.advice-from-childline').find('h1'),
			h2 = $('.advice-from-childline').find('h2'),
			body = $('.advice-from-childline').find('.videos');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
	...
	bpc.page5out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.advice-from-childline').hide(0); }});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.advice-from-childline').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
	...
	bpc.page6in = function() {
		try {
			lypn_trackPageView('how-to-help');
		} catch(err) {
			console.log(err);
		}
		$('.how-to-help').css('display', 'table');//show(0);
		var back = $('.how-to-help').find('.background'),
			h1 = $('.how-to-help').find('h1'),
			body = $('.how-to-help').find('.body');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
		TweenMax.killTweensOf(body);
	...
	bpc.page6out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.how-to-help').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(body, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.how-to-help').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			TweenMax.to(body, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.page7in = function() {
		try {
			lypn_trackPageView('uk-partners');
		} catch(err) {
			console.log(err);
		}
		$('.uk-partners').css('display', 'table');//show(0);
		var back = $('.uk-partners').find('.background'),
			h1 = $('.uk-partners').find('h1'),
			body = $('.uk-partners').find('.body');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
		TweenMax.killTweensOf(body);
	...
	bpc.page7out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.uk-partners').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(body, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.uk-partners').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			TweenMax.to(body, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.page8in = function() {
		try {
			lypn_trackPageView('get-help');
		} catch(err) {
			console.log(err);
		}
		$('.get-help').css('display', 'table');//show(0);
		var back = $('.get-help').find('.background'),
			h1 = $('.get-help').find('h1'),
			p = $('.get-help').find('p');
		TweenMax.killTweensOf(back);
		TweenMax.killTweensOf(h1);
	...
	bpc.page8out = function() {
		...
		if (bpc.scrollDirection === 'up') {
			TweenMax.to(back, 0.5, {css: {top: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.get-help').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0.2});
			TweenMax.to(p, 0.5, {css: {top: 120}, ease: Quart.easeOut, delay: 0});
			...
			TweenMax.to(back, 0.5, {css: {bottom: '100%'}, ease: Quart.easeOut, delay: 0.4, onComplete: function() { $('.get-help').hide(0); }});
			TweenMax.to(h1, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0});
			TweenMax.to(p, 0.5, {css: {top: -120}, ease: Quart.easeOut, delay: 0.2});
	...
	bpc.initWhatCanIDo = function() {
		$('.what-can-i-do .button').click(function() {
			$('.what-can-i-do .copy.open').slideUp(300, 'easeOutQuart').removeClass('open').next('.button').show(0);
		...
		var index = 0;
		$('.what-can-i-do .arrows.right').click(function() {
			console.log(index);
			if (index < 2) {
				index++;
				$('.what-can-i-do .arrows.left').show(0);
				TweenMax.to($('.what-can-i-do .flick-mask'), 0.5, {css: {marginLeft: -(index*100)+'%'}, ease: Quart.easeOut});

				if (index === 2) $('.what-can-i-do .arrows.right').hide(0);
			}
		});
		$('.what-can-i-do .arrows.left').click(function() {
			console.log(index);
			if (index > 0) {
				index--;
				$('.what-can-i-do .arrows.right').show(0);
				TweenMax.to($('.what-can-i-do .flick-mask'), 0.5, {css: {marginLeft: -(index*100)+'%'}, ease: Quart.easeOut});

				if (index === 0) $('.what-can-i-do .arrows.left').hide(0);
			}
		});
	};
	...
	bpc.initCelebVids = function() {
		...
		$('.advice-from-childline').on('swipeleft', function(){
			if ($('.advice-from-childline .arrows.right').is(':visible'))
				$('.advice-from-childline .arrows.right').click();
		});
		$('.advice-from-childline').on('swiperight', function(){
			if ($('.advice-from-childline .arrows.left').is(':visible'))
				$('.advice-from-childline .arrows.left').click();
		});*/
	};
